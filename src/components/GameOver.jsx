...
{(winner==="X" && player1)?
  ...
  :null
    ...
    </div>  <button onClick={handlereset}
      className="goo hover:bg-fuchsia-800 border-2 m-5 p-5 px-10 rounded-3xl">REMATCH</button>
    </div>
  );
}
